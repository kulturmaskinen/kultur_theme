        ...
        if ($(window).width() < 768) {
            ...
            if ($(window).width() < 768) {
               ...
               $(".view-id-calendar .views-field-field-br-dtekst a").attr('href','/calendar-node-field-dato/day');
                ...
                $('.node-title').prependTo($('.col-lg-5.col-md-6.col-sm-6.col-xs-12.col-xs-height.col-full-height').parent());
            } else {
                ...
                $('.col-lg-2.col-md-4.col-sm-4.col-xs-12.col-sm-height.col-md-height.col-xs-height.col-full-height.col-top').prependTo($('.node-title').parent());
            }
